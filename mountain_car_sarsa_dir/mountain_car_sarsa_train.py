...
def main():
    ...
    #plt.show()
    plt.savefig('mountaincar_reward_sarsa_{f}'.format(f=num_eps))

    np.save('./mountain_car_sarsa/mountain_car_sarsa_{f}_episodes_mean_rewards.npy'.format(f=str(num_episodes)), mean_rewards)
