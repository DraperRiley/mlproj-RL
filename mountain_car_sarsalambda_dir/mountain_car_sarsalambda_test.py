...
def main():
    ...
    q_table = np.load('./mountain_car_sarsalambda/mountain_car_sarsalambda_10000_episodes.npy')
    #print(q_table)
...
def run():
    ...
    q_table = np.load('./mountain_car_sarsalambda/mountain_car_sarsalambda_9900_episodes.npy')
